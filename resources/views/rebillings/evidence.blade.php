@extends('layouts.app', ['activePage' => 'orders', 'titlePage' => __('Evidencia de refacturación')])
...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ route('rebillings.store') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    <input type="hidden" name="type" value="evidence">
                    <input type="hidden" name="order_id" value="{{ $order->id }}">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h4 class="card-title">Subir evidencia de refacturación</h4>
                        ...
                        <div class="card-body ">
                            ...
                            @if ( isset($order->rebilling) )
                                <input type="hidden" name="oldRebilling" value="true" class="form-control">
                                <input type="hidden" name="rebillingId" value="{{ $order->rebilling->id }}" class="form-control">
                            @else
                                <div class="row">
