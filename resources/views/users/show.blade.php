        ...
        <div class="card">
            ...
            <div class="card-body ">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7">
                        <div class="form-group bmd-form-group is-filled">
                            <input class="form-control" name="email" id="input-email" type="text" placeholder="Email" value="{{ $user->created_at->toDateTimeString() }}" disabled="">
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-7">
                        <div class="form-group bmd-form-group is-filled">
                            <input class="form-control" name="email" id="input-email" type="text" placeholder="Email" value="{{ $user->updated_at->toDateTimeString() }}" disabled="">
                        </div>
                    </div>
                </div>
